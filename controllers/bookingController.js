...
// // CREATE: Linking to User 1 automatically
// exports.createBooking = async (req, res, next) => {
//     try {
//         const { service_id, booking_date, time_slot, notes } = req.body;
        
//         // NO AUTH: Manually setting User 1 and Status 1 (Scheduled)
//         const user_id = 1;
//         const status_id = 1;
...
// // READ: Fetching bookings for User 1
